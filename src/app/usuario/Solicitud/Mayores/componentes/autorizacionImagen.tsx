        ...
        <div>
            ...
            <div className='flex flex-col '>
                ...
                <div className='flex  justify-center lg:w-1/2 md:1/2 sm:w-2/3 mx-auto mt-5 max-h-[45vh] overflow-y-auto border border-gray-300 rounded-lg p-4 shadow-sm'>
                    <p className='mx-auto w-full md:'>Por medio de la presente, Autorizo al Centro Educativo y Terapéutico “Casa Jardín”, a utilizar de manera amplia, irrestricta
                        y gratuita las imágenes CUIDADAS en las que apareciera, en las actividades del mismo, con la
                        promoción difusión y conocimiento de sus actividades
                        <br />Renuncio expresa e irrevocablemente a todo y cualquier tipo de reclamo contra CET, sus
                        directores, autoridades y miembros en relación a los derechos autorizados por medio de la
                        presente sobre las imágenes y/o percibir cualquier suma en concepto de indemnización o
                        remuneración por los usos autorizados precedentemente indicados, relevando a CET de
