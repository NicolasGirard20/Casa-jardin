    ...
    <main className="min-h-screen bg-gray-50">
      ...
      {error != '' && <div className="fixed inset-0 flex items-center justify-center bg-black/50">
        <div className="bg-white border p-4 rounded-md shadow-md w-96">
          <h2 className="text-lg font-bold text-red-600 mb-2">Complete los datos de su cuenta</h2>
          <p className="text-sm  mb-4">{error}. Completelos <a href="/usuario/Cuenta" className='underline hover:font-semibold'>aquí</a> </p>
